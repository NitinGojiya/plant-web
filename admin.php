...
<div class="left-navigation">
    ...
    <li><a  href="home.php">Today Selling</a></li>
        <li><a  href="profile.php">Total selling</a></li>
        <li><a href="cart.php">Insert Plants</a></li>
       
        <li>
            <!-- Add a class to the button for styling and reference in JavaScript -->
            <a href="cate.php" class="categories-button" id="m" >Delete Plants</a>
 ...
 <section class="main" id="today">
        <div class="main-top">
                <h1 style="color: #fff; text-decoration:underline; margin-bottom:20px;">Today </h1>
            </div>
            <div class="thead">
        <div class="th">
            <div>Plant Name</div>
